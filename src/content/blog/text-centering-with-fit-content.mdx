...
<figure>
<img src="/images/blog/text-centering-with-fit-content/fit-content.jpg" alt="文字が不揃いではなく、面位置が揃って綺麗な様子" width="720" height="420" loading="lazy" />
...
本当に垂直方向を`0`にしていいのかは考えましょう。 個別の指定の方が副作用が起こらない可能性は高いです。
</div>
