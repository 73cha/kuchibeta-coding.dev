...
[Invalid at computed-value time](https://www.matuzo.at/blog/2023/invalid-custom-properties)から引用
> カスタムプロパティの宣言は、その値が無効な場合、計算値の時点で無効になることがあります。プロパティの型にもよるが、この場合、プロパティはunsetに設定されるので、プロパティが継承されているかどうかによって、プロパティの継承値か初期値のどちらかになる。
